...
- ink to it: [My Resume Website](https://www.alexandrepereira.site/).
...
![image](https://github.com/user-attachments/assets/4620ba48-5c96-4376-9a77-1ddfb2591ae6)
...
-   In it we add a "key:value" pair with the CosmosDB primary connection string.
	...
	```
	"AzureResumeConnectionString": "Connection string".
	```
...
### 3.  Connecting the frontend with the backend:
...
-   We then run in the backend/api folder:
...
### 5.  Building CI/CD pipeline with GitHub:
